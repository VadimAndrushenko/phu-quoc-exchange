...
export default function ButtonContact({ className }: { className?: string }) {
            ...
            { 
                ...
                <Link
                    ...
                    className={cn(
                        ...
                        item.label === 'Telegram' 
                            ? 
                                `
                                    ${connectionOpen ? "translate-y-[120%] max-lg:translate-y-[100%] " : "opacity-0"}
                ...
                >
                    <span className="flex items-center gap-4 z-10 max-sm:gap-2 " >
                        <item.icon className="w-5.5 max-sm:w-4" />
                        {item.label}
                    </span>
                </Link>
            ))}
